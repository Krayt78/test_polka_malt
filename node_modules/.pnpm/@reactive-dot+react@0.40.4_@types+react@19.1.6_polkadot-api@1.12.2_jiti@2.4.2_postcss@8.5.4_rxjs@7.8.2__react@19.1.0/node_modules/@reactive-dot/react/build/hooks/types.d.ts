...
export type QueryArgument<TChainId extends ChainId | undefined> = Query<QueryInstruction[], ChainDescriptorOf<TChainId>> | ((query: Query<[], ChainDescriptorOf<TChainId>>) => Query<QueryInstruction[], ChainDescriptorOf<TChainId>> | Falsy) | Falsy;
