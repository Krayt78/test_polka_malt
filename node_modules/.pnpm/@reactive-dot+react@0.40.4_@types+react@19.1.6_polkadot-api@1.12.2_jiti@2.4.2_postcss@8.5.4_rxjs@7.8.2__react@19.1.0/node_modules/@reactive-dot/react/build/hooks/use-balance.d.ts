 ...
 */
export declare function useSpendableBalance(address: SS58String, options?: Options): DenominatedNumber;
/**
 ...
 */
export declare function useSpendableBalance(addresses: SS58String[], options?: Options): DenominatedNumber[];
export {};
