 ...
 */
export declare function useLazyLoadQuery<TChainId extends ChainId | undefined, TQuery extends QueryArgument<TChainId>>(query: TQuery, options?: ChainHookOptions<TChainId> & FetchOptions): InferQueryArgumentResult<TChainId, TQuery>;
/**
 * Hook for querying data from chain, and returning the response.
 *
 * @group Hooks
