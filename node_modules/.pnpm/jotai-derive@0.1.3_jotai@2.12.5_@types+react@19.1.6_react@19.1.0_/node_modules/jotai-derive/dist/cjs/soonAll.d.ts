 ...
 */
export declare function soonAll<T extends readonly [unknown, ...unknown[]] | []>(values: T): SoonAll<T>;
export declare function soonAll<T extends readonly unknown[]>(values: T): SoonAll<T>;
export {};
