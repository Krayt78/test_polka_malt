...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<Ie4avbuq9969dj>, false, never>;
        /**
...
type ICalls = {
    ...
    Utility: {
         ...
         * event is deposited.
         */
        batch: TxDescriptor<Anonymize<I3smndd7h2fmq8>>;
        /**
         ...
         * The dispatch origin for this call must be _Signed_.
         */
        as_derivative: TxDescriptor<Anonymize<I1ijbagkn1ordu>>;
        /**
         ...
         * - O(C) where C is the number of calls to be batched.
         */
        batch_all: TxDescriptor<Anonymize<I3smndd7h2fmq8>>;
        /**
         ...
         * - O(1).
         */
        dispatch_as: TxDescriptor<Anonymize<Ia276ihgncsaus>>;
        /**
         * Send a batch of dispatch calls.
         ...
         * - O(C) where C is the number of calls to be batched.
         */
        force_batch: TxDescriptor<Anonymize<I3smndd7h2fmq8>>;
        /**
         ...
         * The dispatch origin for this call must be _Root_.
         */
        with_weight: TxDescriptor<Anonymize<Iecvj70ddkhh3f>>;
    };
    Multisig: {
        /**
         ...
         */
        as_multi_threshold_1: TxDescriptor<Anonymize<I8s3b9p1g5e4ql>>;
        /**
         ...
         */
        as_multi: TxDescriptor<Anonymize<Ic7o7iq3v6qo46>>;
        /**
         * Register approval for a dispatch to be made from a deterministic composite account if
         * approved by a total of `threshold - 1` of `other_signatories`.
         *
    ...
    Proxy: {
         ...
         */
        proxy: TxDescriptor<Anonymize<I336amehbj1mdj>>;
        /**
         ...
         * - `call`: The call to be made by the `real` account.
         */
        proxy_announced: TxDescriptor<Anonymize<I88r9ku3v97190>>;
    };
    Assets: {
        /**
    ...
    Sudo: {
         ...
         */
        sudo: TxDescriptor<Anonymize<Ifhi40uuj2vrtj>>;
        /**
         * Authenticates the sudo key and dispatches a function call with `Root` origin.
         * This function does not check the weight of the call, and instead allows the
         ...
         * The dispatch origin for this call must be _Signed_.
         */
        sudo_unchecked_weight: TxDescriptor<Anonymize<Iecvj70ddkhh3f>>;
        /**
         ...
         * The dispatch origin for this call must be _Signed_.
         */
        sudo_as: TxDescriptor<Anonymize<I3rivcrtanu30s>>;
        /**
...
type IEvent = {
    System: {
         ...
         * An extrinsic failed.
         */
        ExtrinsicFailed: PlainDescriptor<Anonymize<I22b1jg4rodoll>>;
        /**
         * `:code` was updated.
         */
    ...
    Utility: {
         ...
         * well as the error.
         */
        BatchInterrupted: PlainDescriptor<Anonymize<I4lgje4pq6sk02>>;
        /**
         ...
         */
        ItemFailed: PlainDescriptor<Anonymize<I5cc2dvs765cgm>>;
        /**
         * A call was dispatched.
         */
        DispatchedAs: PlainDescriptor<Anonymize<I7cb9u4slmqbmo>>;
    };
    Multisig: {
        /**
         ...
         */
        MultisigExecuted: PlainDescriptor<Anonymize<I8t5rtdjrlba5c>>;
        /**
    ...
    Proxy: {
         ...
         */
        ProxyExecuted: PlainDescriptor<Anonymize<I7cb9u4slmqbmo>>;
        /**
    ...
    Sudo: {
         ...
         */
        Sudid: PlainDescriptor<Anonymize<I260daj4g65r34>>;
        /**
         ...
         */
        SudoAsDone: PlainDescriptor<Anonymize<I260daj4g65r34>>;
    };
};
type IError = {
    System: {
...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Binary], Anonymize<Icdp869hbh7i6f>>;
        /**
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<I36ockpredaaf9>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<I36ockpredaaf9>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    DryRunApi: {
         ...
         * Dry run call V2.
         */
        dry_run_call: RuntimeDescriptor<[origin: Anonymize<Idmvmjvl6cdqa6>, call: Anonymize<I36ockpredaaf9>, result_xcms_version: number], Anonymize<Ibm11b8frcsn8j>>;
        /**
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: PaseoXcmVersionedLocation, xcm: PaseoXcmVersionedXcm], Anonymize<Ia6oma2dh07vk>>;
    };
    /**
...
export type Paseo_asset_hubDispatchError = Anonymize<I7jp9lqq8djc9r>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type Paseo_asset_hubApis = ApisFromDef<IRuntimeCalls>;
...
export type Paseo_asset_hubViewFns = ViewFnsFromPalletsDef<PalletsTypedef>;
export type Paseo_asset_hubCallData = Anonymize<I36ockpredaaf9> & {
    value: {
        type: string;
    };
};
export type Paseo_asset_hubWhitelistEntry = PalletKey | ApiKey<IRuntimeCalls> | `query.${NestedKey<PalletsTypedef['__storage']>}` | `tx.${NestedKey<PalletsTypedef['__tx']>}` | `event.${NestedKey<PalletsTypedef['__event']>}` | `error.${NestedKey<PalletsTypedef['__error']>}` | `const.${NestedKey<PalletsTypedef['__const']>}` | `view.${NestedKey<PalletsTypedef['__view']>}`;
